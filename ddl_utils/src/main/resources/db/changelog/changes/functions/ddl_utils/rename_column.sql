CREATE OR REPLACE FUNCTION ddl_utils.rename_column(
...
BEGIN
    ...
    PERFORM ddl_utils_lib.rename_column(
            ...
            i_new_column_name => i_new_column_name,
...
COMMENT ON FUNCTION ddl_utils.rename_column IS
    'Lock-aware wrapper: renames a column.';
