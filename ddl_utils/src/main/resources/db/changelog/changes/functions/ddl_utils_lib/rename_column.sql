CREATE OR REPLACE FUNCTION ddl_utils_lib.rename_column(
...
$$
BEGIN
    -- Both names are identifiers, so they are quoted with %I and the fragment
    -- contains no caller-supplied SQL.
